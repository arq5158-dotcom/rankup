...
function PayCancel() {
  return (
    <div className="relative flex min-h-screen flex-col">
      <Navbar />
      <main className="relative z-10 mx-auto flex w-full max-w-lg flex-1 flex-col items-center px-4 py-20 text-center">
        <div className="glass-card w-full rounded-2xl p-8">
          ...
          <p className="mt-2 text-sm text-white/45">
            No charge was made. You can buy credits whenever you're ready.
          </p>
